...
echo "UNFORTUNATLY, THE OUTLINE SCRIPT CANNOT BE RUN IN THIS CURRENT SESSION WITHOUT DOCKER COMPLAINING. PLEASE EXIT THIS SESSION AND START A NEW ONE, THEN EXECUTE IT"
